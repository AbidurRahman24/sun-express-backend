"""
Django settings for sunExpress project.
...
SECRET_KEY = 'django-insecure-!j60%v9y-s++qf7gg%0&*ry3!744g*))a3%175xwpxuk536p_)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://sunexpress.onrender.com','https://*.127.0.0.1']
